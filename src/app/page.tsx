		...
		<main className="page-shell">
			<section className="panel">
				...
				<p className="subtitle">
					Infinite procedural yellow-office maze in first person with
					deterministic chunk generation, desktop WASD controls, and analog
					tape-style image artifacts.
				</p>
				...
				<div className="kv-grid">
					<article className="kv-card">
						...
						<span className="v">W A S D + Mouse</span>
					</article>
					<article className="kv-card">
